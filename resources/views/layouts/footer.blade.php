<footer class="site-footer">
    <div class="container">
      <div class="row">
        <div class="col-lg-4">
          <div class="mb-5">
            <h3 class="footer-heading mb-4">ASobre MeuKubico</h3>
            <p>Bem-vindo à Meu Kubico, a sua plataforma online de referência para a disponibilização de propriedades imobiliárias em Angola.
