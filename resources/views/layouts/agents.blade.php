      ...
      <div class="row">
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
            <div class="team-member">
              ...
              <img src="{{ asset('frame/images/person_1.jpg') }}" alt="Image" class="img-fluid rounded mb-4">
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-5">
            <div class="team-member">
              ...
              <img src="{{ asset('frame/images/person_2.jpg') }}" alt="Image" class="img-fluid rounded mb-4">
